...
|                   | Expected to have enforced required fields, and prevent submission of empty form                           | Attempt to submit empty fields                                                         | Navigation links functional and accessible                                           | ![screenshot](documentation/defensive/empty-name.png),![screenshot](documentation/defensive/empty-email.png) |                 |
